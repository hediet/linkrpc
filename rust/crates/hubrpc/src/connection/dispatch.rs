...
///
/// The `#[hub_rpc_interface]` macro implements this for the generated `…Server` adapter, letting
/// [`HubRpcConnection::register_service`](crate::connection::hub_connection::HubRpcConnection::register_service)
