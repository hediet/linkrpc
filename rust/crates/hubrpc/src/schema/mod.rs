...
//!
//! - [`interface_schema`] — the `HubRpcInterfaceSchema` model.
//! - [`normalize`] — raw JSON Schema → decidable hubrpc subset (zod↔schemars bridge).
...
pub use interface_schema::{
    Components, ErrorSchema, HubRpcInterfaceSchema, MemberAnnotations, MethodMap, MethodSchema,
};
