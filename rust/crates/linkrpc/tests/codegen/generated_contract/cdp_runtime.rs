...
pub struct EvaluateResult {
    pub object: super::types::RuntimeRemoteObject,
}

impl EvaluateResult {
    /// Construct with all required fields; optional fields default to `None`
    /// and any open-object extra map defaults to `Default::default()`.
    pub fn new(object: super::types::RuntimeRemoteObject) -> Self {
        Self {
            object,
        }
    }
...
pub trait CdpRuntimeService {
    ...
    #[name("evaluate")]
    async fn evaluate(expression: String) -> Result<EvaluateResult, linkrpc::prelude::RpcCallError> {
    ...
    #[name("fallible")]
    async fn fallible(#[params] params: serde_json::Value) -> Result<serde_json::Value, FallibleError> {
        let _ = (ctx, params,);
        Err(FallibleError::Generic(linkrpc::prelude::RpcCallError::Local(linkrpc::prelude::JsonRpcError::new(linkrpc::prelude::error_codes::METHOD_NOT_FOUND, "fallible"))))
    }
    #[name("unsupported")]
...
pub const ROOT: linkrpc::binding::InterfaceBinding<CdpRuntimeClient> = linkrpc::binding::InterfaceBinding::new(linkrpc::binding::BindingAddress::Root);

pub const SERVICE_1: linkrpc::binding::InterfaceBinding<CdpRuntimeClient> = linkrpc::binding::InterfaceBinding::new(linkrpc::binding::BindingAddress::Service("debug"));

pub const DEFAULT: linkrpc::binding::InterfaceBinding<CdpRuntimeClient> = linkrpc::binding::InterfaceBinding::new(linkrpc::binding::BindingAddress::Default);

pub const BARE_0: linkrpc::binding::InterfaceBinding<CdpRuntimeClient> = linkrpc::binding::InterfaceBinding::new(linkrpc::binding::BindingAddress::Bare("Runtime."));
