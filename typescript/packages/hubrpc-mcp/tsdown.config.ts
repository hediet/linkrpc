...
// Three entries: the library `index` / `node` surfaces and the `hubrpc-mcp`
// CLI (bin). Runtime `dependencies` (@modelcontextprotocol/sdk, quickjs,
// @vscode/hubrpc*, zod) stay external and resolve from node_modules. The
// source-only `@vscode/hubrpc-client` dev dep is bundled in.
//
...
export default defineConfig({
    ...
    deps: {
        alwaysBundle: ['@vscode/hubrpc-client'],
    },
