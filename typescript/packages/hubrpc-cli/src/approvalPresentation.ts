import { jcsCanonicalize, type Pattern, type Permission } from '@vscode/hubrpc';
import type { HubAccessManifestRequest } from '@vscode/hubrpc/hub/common';
import type { AccessDirectPermission } from '@vscode/hubrpc-hub/hub/server';
