 ...
 * of this string registers a native completer for both `hub` and `hubrpc`.
 *
 * Notes:
...
# hubrpc completion for PowerShell — auto-generated by \`hub completions powershell\`.
# Install once with:  hub completions powershell | Out-String | Invoke-Expression
# Persist with:       hub completions powershell >> $PROFILE
Register-ArgumentCompleter -Native -CommandName hub,hubrpc -ScriptBlock {
