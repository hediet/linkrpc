import { ErrorCode, type JsonValue, RpcError } from '@vscode/hubrpc';
...
import { type CliChannel, findMethodInSchema } from '@vscode/hubrpc-client';
...
import type { HubRpcInterfaceSchema as SvcInterfaceSchema, MethodSchema } from '@vscode/hubrpc';
