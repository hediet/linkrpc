import { ErrorCode, type IncomingCall, type IRequestHandler, type JsonValue, RpcError } from '@vscode/hubrpc';
import { hubGrantedServiceIdInterface } from '@vscode/hubrpc/hub/common';
import { hubServiceIdRegistryInterface } from '@vscode/hubrpc/hub/common';
