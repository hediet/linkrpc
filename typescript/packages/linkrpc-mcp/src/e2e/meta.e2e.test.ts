 ...
 * `con.getDocs()` payload.
 */
describe("LinkRpcMcpServer e2e (MCP tool catalog + documentation)", () => {
              ...
              },
              {
                ...
                "inputSchema": {
                  ...
                  "properties": {
                    ...
                    "taskId": {
                      "description": "Task id returned by \`runLinkRpcScript\`.",
                      "type": "string",
                    },
                    "timeoutMs": {
