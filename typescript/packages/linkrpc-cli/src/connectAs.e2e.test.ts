...
import { InMemoryManagedIdentityStorage } from '@hediet/linkrpc';
...
async function makeHub(): Promise<{
    ...
    brokerConn: LinkRpcConnection;
    attachConsumer(): LinkRpcConnection;
    ...
    registerConnectionTokenBinderService(services.connection as unknown as LinkRpcConnection, {
        store,
