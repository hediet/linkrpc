...
import type { Permission, PrincipalId, SignedCapability } from '@vscode/hubrpc';
import { HubRpcConnection, InMemoryManagedIdentity, TransportPair } from '@vscode/hubrpc';
...
function wire(acceptableRootIds?: string[]) {
    ...
    const client = HubRpcConnection.fromTransport(pair.b);
