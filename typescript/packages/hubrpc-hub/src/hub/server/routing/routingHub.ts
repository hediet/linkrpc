...
import { ErrorCode, isNotification, isRequest, isResponse, RpcError, TransportPair } from '@vscode/hubrpc';
import type { IMessageTransport, JsonRpcMessage, JsonRpcRequest, JsonRpcResponse, RequestId } from '@vscode/hubrpc';
...
/**
 * A **Hub** is the entire routing concept of hubrpc v2 — the only noun.
