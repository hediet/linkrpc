...
import { nodeInterface, type TopologyTransportInfo } from '@vscode/hubrpc/hub/common';
...
export class RootOverlay<TContext = undefined> {
     ...
     */
    public readonly root: HubRpcConnection<TContext>;
    ...
    constructor(options: RootOverlayOptions) {
        ...
        this.root = HubRpcConnection.fromTransport<TContext>(this._rootPair.b);
