...
import { TopologyClient, TrafficClient } from '@vscode/hubrpc/hub/client';
import { topologyInterface, type TrafficTransitEvent } from '@vscode/hubrpc/hub/common';
...
describe('HubInspector', () => {
    ...
    it('reports the raw failed forwarding transit', async () => {
        ...
        const connection = HubRpcConnection.fromTransport(callerLink.transport);
