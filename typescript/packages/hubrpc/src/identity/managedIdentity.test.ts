...
/**
 * Wire two HubRpcConnections back-to-back: `executor` plays the role of
 ...
 * overlay.
 */
function _pair(): { executor: HubRpcConnection; sender: IRequestSender<unknown> } {
    const pair = new TransportPair();
    const executor = HubRpcConnection.fromTransport(pair.a);
