...
import type { HubRpcInterfaceSchema, MethodSchema } from "./hubRpcInterfaceSchema";
 ...
 *      `components.schemas`) onto the decidable hubrpc subset.
 ...
 */
export function computeInterfaceHash(schema: HubRpcInterfaceSchema): string {
...
function normalizeSchemaPositions(schema: HubRpcInterfaceSchema): HubRpcInterfaceSchema {
    const methods: HubRpcInterfaceSchema["methods"] = Object.fromEntries(
