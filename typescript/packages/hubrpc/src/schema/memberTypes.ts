...
import type { MemberAnnotations } from './hubRpcInterfaceSchema';
import type { HubRpcJsonSchema } from './hubRpcJsonSchema';

/**
 * The schema type hubrpc accepts everywhere: the zod *core* base shared by
 ...
 * for ergonomics, mini for minimal bundle size — while hubrpc's own internal
...
export interface ZodToSvcJsonSchemaOptions {
    ...
    readonly components: Record<string, HubRpcJsonSchema>;
}
