...
import type { HubRpcInterfaceSchema, MethodSchema } from '../../schema/hubRpcInterfaceSchema';
...
export async function fetchSchema(
    ...
    const raw = await channel.sendRequest(method, params);
    const wrap = raw as unknown as { schema: HubRpcInterfaceSchema; };
    return wrap.schema;
}
