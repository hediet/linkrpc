// Emits the pizza interface schema + hash from the REAL TypeScript linkrpc impl (zod →
...
// identical `id@hash`.
//
// Method names + param field names are snake_case to match what the Rust `#[link_rpc_interface]`
...
// `zod`) from the TS package; set LINKRPC_TS_DIST to override the dist path.
...
const distPath =
  process.env.LINKRPC_TS_DIST ??
  join(here, "..", "..", "typescript", "packages", "linkrpc", "dist", "index.js");
