...
// `linkrpc/src/connection/endpointUri.ts` (the real functions are tree-shaken out of the dist,
// so we port the ~70 lines verbatim using Node's `URL`, exactly like the source). The Rust
// `parse_endpoint_uri`/`format_endpoint_uri`/`is_hub_endpoint` (crates/linkrpc/src/connection/
